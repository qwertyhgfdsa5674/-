 ...
 *   node .claude/workflows/claude-codex-loop.js apply-review .claude/handoff/current-review-result.json
 *   node .claude/workflows/claude-codex-loop.js reset-task task-003
 */
